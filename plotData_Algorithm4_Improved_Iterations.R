...
# plot iterations
plot(completeGraphData$'nodes', completeGraphData$'iterations', pch=PLOT_PCH_COMPLETE_GRAPH, col=PLOT_COL_COMPLETE_GRAPH, type=PLOT_TYPE, xlab=PLOT_X_LAB, ylab=PLOT_Y_LAB, , ylim=c(0,6))
